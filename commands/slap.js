...
module.exports.run = async (client, message, args) => {
    ...
    const self = new Discord.MessageEmbed().setColor('RANDOM').setDescription(`You can't slap yourself.`).setFooter(`Attempted by: ` + message.author.username, message.author.avatarURL());
...
.setImage(`https://thumbs.gfycat.com/OblongFickleGarpike-size_restricted.gif`)
.setColor('RANDOM')
.setFooter(`Slapped by ${message.author.username}`, `${message.author.displayAvatarURL({ dynamic: true })}`)
