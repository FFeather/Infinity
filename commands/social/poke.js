...
module.exports.run = async (client, message, args) => {
    ...
    const self = new Discord.MessageEmbed().setColor('RANDOM').setDescription(`You can't poke yourself.`).setFooter(`Attempted by: ` + message.author.username, message.author.avatarURL());
...
.setImage(`https://i.pinimg.com/originals/40/54/5c/40545c887023ba16e26f094bdb335271.gif`)
.setColor('RANDOM')
.setFooter(`Poked by ${message.author.username}`, `${message.author.displayAvatarURL({ dynamic: true })}`)
